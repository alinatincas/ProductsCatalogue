...
namespace ProductsCategories
{
    public class DbProvider
    {
        public static void saveProducts(string path)
        {
            ...
            {
                new Product("KitKat", "Nestlé", "United Kingdom", Category.Name.Chocolate,
                ...
                new Product("Snickers", "Mars", "United Kingdom", Category.Name.Chocolate,
                ...
                new Product("Gummy bears", "Hans Riegel", "Germany", Category.Name.Jelly,
                ...
                new Product("Bêtise de Cambrai", "Afchain", "France", Category.Name.Wrapped_Candies,
                ...
                new Product("Jolly Rancher", "The Hershey Company", "United States", Category.Name.Wrapped_Candies,
                ...
                new Product("Red Vines", "American Licorice Company", "California", Category.Name.Licorice,
                ...
                new Product("Chupa Chups", "Enric Bernat", "Spain", Category.Name.Lollypop,
